...
if __name__=='__main__':
    ...
    ax3 = plt.subplot2grid((3,3),[1,0], sharex=ax2)
    ax4 = plt.subplot2grid((3,3),[2,0], sharex=ax2)
    ax5 = plt.subplot2grid((3,3),[0,1])
    ax6 = plt.subplot2grid((3,3),[1,1], sharex=ax5)
    ax7 = plt.subplot2grid((3,3),[2,1], sharex=ax5)
